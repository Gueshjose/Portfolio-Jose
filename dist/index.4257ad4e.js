...
})({"isUgn":[function(require,module,exports) {
"use strict";
...
let c = 0;
class DisableScrollPlugin extends (0, _smoothScrollbar.ScrollbarPlugin) {
...
// load the plugin
(0, _smoothScrollbarDefault.default).use(DisableScrollPlugin);
class AnchorPlugin extends (0, _smoothScrollbar.ScrollbarPlugin) {
...
// usage
(0, _smoothScrollbarDefault.default).use(AnchorPlugin);
let barInterval = setInterval(()=>{
    ...
    if (c === 101) {
        ...
        (0, _gsapDefault.default).to(".loading_bar", {
            duration: 3,
            rotate: "90deg",
            top: "200%",
            left: "1000%"
        });
        (0, _gsapDefault.default).to(".loading_text, .loading_counter", {
            duration: 0.5,
            opacity: 0
        });
        (0, _gsapDefault.default).to(".loading_box", {
            duration: 1,
            height: "500px",
            borderRadius: "50%"
        });
        (0, _gsapDefault.default).to(".loading_svg", {
            duration: 5,
            opacity: 1,
            rotate: "360deg"
        });
        ...
        (0, _imagesloadedDefault.default)(document.querySelectorAll("img"), ()=>{
            ...
            (0, _gsapDefault.default).to(".socials", {
                duration: 1,
                delay: 2.5,
                bottom: "10rem"
            });
            (0, _gsapDefault.default).to(".scrollDown", {
                duration: 1,
                delay: 3,
                bottom: "3rem"
            });
            (0, _gsapDefault.default).to(".intro", {
                duration: 1,
                delay: 4,
                left: "5%"
            });
            setTimeout(()=>{
                ...
                let pageSmoothScroll = (0, _smoothScrollbarDefault.default).init(document.body, options);
...
},{"gsap":"fPSuC","imagesloaded":"aYzyZ","smooth-scrollbar":"7azJf","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["isUgn","9OMkf"], "9OMkf", "parcelRequire2041")
